...
import com.example.chapter3.compat.getParcelable
import com.example.chapter3.databinding.ActivityDetailBinding
...
class DetailActivity : AppCompatActivity() {
    ...
    private fun initViews() {
        with(binding) {
            tvCardTitle.text = intent.getStringExtra(CARD_NAME).orEmpty()
            card.backgroundTintList = intent.getParcelable(CARD_COLOR)
