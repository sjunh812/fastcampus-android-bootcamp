...
import com.sjhstudio.compose.movieapp.library.network.model.RequestType
...
class NetworkRequestFactoryImpl @Inject constructor(
    ...
    override suspend fun <T> create(
        ...
        return try {
            ...
            ApiResult(response = apiResponse, headers = responseHeaders, code = responseCode)
        } catch (e: Exception) {
    ...
    private suspend fun performPostRequest(
        ...
        apiService.post(url = url, body = body, headerMap = headers)
    } ?: apiService.post(url = url, headerMap = headers)
    ...
    private suspend fun performPutRequest(
        ...
        apiService.put(url = url, body = body, headerMap = headers)
    ...
    private suspend fun performDeleteRequest(
        ...
        apiService.delete(url = url, body = body, headerMap = headers)
